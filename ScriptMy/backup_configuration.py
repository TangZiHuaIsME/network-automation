# config_backup.py
# What it does: SSHes into every device, runs the show running-config
# command, and saves each device's full configuration to a separate
# dated file. Automates what network engineers do manually during
